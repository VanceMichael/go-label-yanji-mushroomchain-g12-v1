...
func (s Settlement) RequirePaymentVersion(expectedVersion int64) error {
	if s.Status != SettlementApproved {
		return StateError{Entity: "settlement", From: string(s.Status), To: string(SettlementPaid)}
	}
