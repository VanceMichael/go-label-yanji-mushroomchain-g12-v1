...
func (a *API) createOrder(w http.ResponseWriter, r *http.Request) {
	...
	order, err := a.orders.Create(r.Context(), service.CreateOrderInput{BuyerName: body.BuyerName, DeliveryRegion: body.DeliveryRegion, DueAt: body.DueAt, Lines: body.Lines, IdempotencyKey: r.Header.Get("Idempotency-Key"), RequestID: middleware.RequestID(r.Context())})
	if err != nil {
		writeError(w, r, err)
		return
	}
