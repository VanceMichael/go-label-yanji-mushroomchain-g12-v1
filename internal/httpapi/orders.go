...
func (a *API) createOrder(w http.ResponseWriter, r *http.Request) {
	...
	if idempotencyKey == "" {
		writeError(w, r, domain.FieldError{Field: "Idempotency-Key", Message: "required"})
		return
	}
	order, err := a.orders.Create(r.Context(), service.CreateOrderInput{BuyerName: body.BuyerName, DeliveryRegion: body.DeliveryRegion, DueAt: body.DueAt, Lines: body.Lines, IdempotencyKey: idempotencyKey, RequestID: middleware.RequestID(r.Context())})
	if err != nil {
		writeError(w, r, err)
		return
	}
